// main.cpp version for test (dumps mem)
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        CardInterface iface(std::move(afu), cardMem, memSize);
        bool failed = false;
        ...
        iface.haltCores(1);
        iface.copyFromCard(mem, 0, memSize);

        std::ofstream fOut('mem.bin', std::ios::trunc | std::ios::binary);
        fOut.write(reinterpret_cast<char*>(mem, memSize);
